...
(function (someEveryNS) {
    ...
    console.log('some are blue', widgets.some(function (item) { return item.color === 'blue'; }));
    ...
    console.log('every one is blue', widgets.every(function (item) { return item.color === 'blue'; }));
})(someEveryNS || (someEveryNS = {}));
